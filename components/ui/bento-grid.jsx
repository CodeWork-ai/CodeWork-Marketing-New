...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // light styles
      "bg-black bg-opacity-70 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
      // dark styles
    ...
    <div
      ...
      <div asChild size="sm" className="pointer-events-auto">{cta}</div>
    </div>
    <div
