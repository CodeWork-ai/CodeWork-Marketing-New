...
<h2 className="text-white text-lg sm:text-lg md:text-2xl font-semibold mb-4 sm:mb-6 ml-4 sm:-ml-24 md:-ml-48 flex items-center justify-start">
  ...
  Comprehensive Software Development Solutions
        ...
        <ShineBorder
          className="pt-6 sm:pt-10 mt-8 sm:mt-16 md:mt-32 bg-black text-white py-6 sm:py-8 px-4 sm:px-8 md:px-32 w-full sm:w-[800px] md:w-[1200px] h-[360px] sm:h-[500px] md:h-[556px] 
          rounded-tr-[200px] sm:rounded-tr-[400px] md:rounded-tr-[530px] rounded-br-[200px] sm:rounded-br-[400px] md:rounded-br-[530px] relative overflow-hidden ml-0 sm:ml-[-200px] md:ml-[-320px] mb-8 sm:mb-12"
          color={["#1dcaf5", "#f04f57"]}
          borderRadius="0 530px 530px 0"
        >
          <div className="relative z-10">
