        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— AI & Technology Solutions —</span>
            </div>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-3xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg sm:text-xl md:text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  Helping businesses grow through <span className="text-secondary font-medium">digital solutions</span>, and stay ahead in today's fast-moving <span className="text-secondary font-medium">digital world</span>.
                </p>
              </div>
            </div>
          </div>
