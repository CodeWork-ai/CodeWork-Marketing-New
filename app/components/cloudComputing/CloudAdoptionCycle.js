...
const CloudAdoptionCycle = () => {
  ...
  const icons = [
    ...
    { icon: <TbCloudComputing size={40} />, borderColor: "border-blue-500", textColor: "text-blue-500" },
    { icon: <BsTools size={40} />, borderColor: "border-red-500", textColor: "text-red-500" },
    { icon: <WiCloudy size={40} />, borderColor: "border-purple-500", textColor: "text-purple-500" },
...
export default CloudAdoptionCycle;
