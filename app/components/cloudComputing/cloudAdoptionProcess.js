...
let notifications = [
  {
    ...
    time: "15m ago",
    icon: <FaRobot className="w-6 sm:w-8 h-6 sm:h-8 text-[#6A1B9A]" />,
    color: "#6A1B9A",
  },
  {
    name: "Generative AI",
  ...
  },
  {
    ...
    time: "2m ago",
    icon: <FaChartBar className="w-6 sm:w-8 h-6 sm:h-8 text-[#0288D1]" />,
    color: "#0288D1",
  },
];
...
const Notification = ({ name, description, icon, color, time }) => {
  return (
    <figure
      className={cn(
        "relative min-h-fit w-full max-w-[300px] sm:max-w-[400px] cursor-pointer overflow-hidden rounded-xl p-3 sm:p-6",
    ...
    >
      <div className="flex flex-row items-start gap-3 sm:gap-4">
        ...
        <div className="flex flex-col overflow-hidden">
          ...
          <div className="text-[10px] sm:text-xs mt-1 text-red-400 hover:font-semibold">Read More</div>
        </div>
      </div>
    </figure>
  );
...
const CloudAdoptionProcess = () => {
  return (
    <div
      className={cn(
        "flex flex-col sm:flex-row justify-start w-full pl-5 sm:pl-28 mb-12",
      )}
    >
      <div
        className={cn(
