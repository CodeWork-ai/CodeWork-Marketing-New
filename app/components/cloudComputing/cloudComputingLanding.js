        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— Cloud Computing Solutions —</span>
            </div>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  <span className="text-secondary font-medium">Codework.ai</span> delivers cutting-edge <span className="text-secondary font-medium">cloud computing solutions</span>, helping enterprises migrate, manage, and optimize operations efficiently. With expertise in <span className="text-secondary font-medium">cloud infrastructure</span>, serverless computing, and <span className="text-secondary font-medium">AI-driven automation</span>, solutions are designed to enhance security, scalability, and cost-effectiveness.
                </p>
              </div>
            </div>
          </div>
