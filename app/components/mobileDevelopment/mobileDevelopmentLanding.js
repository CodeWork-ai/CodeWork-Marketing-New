        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— Mobile Development —</span>
            </div>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  <span className="text-secondary font-medium">Codework</span> specializes in developing cutting-edge <span className="text-secondary font-medium">mobile applications</span> to enhance user engagement, optimize business operations, and drive <span className="text-secondary font-medium">digital transformation</span>. With expertise in native app development, <span className="text-secondary font-medium">cross-platform solutions</span>, and <span className="text-secondary font-medium">AI-powered mobile applications</span>, every project is designed for scalability, security, and seamless performance.
                </p>
              </div>
            </div>
          </div>
