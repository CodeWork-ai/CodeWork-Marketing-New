          ...
          <div className="lg:col-span-2 text-left">
            ...
            <div className="heading-container mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-white leading-tight mb-6">
                Scalable and <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">High-Performance Mobile Applications</span> for Business Growth
              </h1>
            ...
            <div className="paragraph-container mb-8 max-w-3xl">
              <p className="text-lg text-white/90 leading-relaxed pl-4 border-l-4 border-secondary/40">
                The core of <span className="text-secondary font-medium">Codework</span> is creating innovative and high-performance mobile applications. Every project is crafted to enhance user engagement and maximize business efficiency. Whether developing a native iOS app, Android application, or cross-platform solution, expert developers ensure scalable, secure, and functionally robust mobile applications that drive measurable results.
              </p>
              
              <div className="mt-6">
                <h3 className="text-lg font-semibold text-secondary mb-4">Transform your business with cutting-edge mobile solutions that engage users.</h3>
              </div>
            </div>
          </div>
