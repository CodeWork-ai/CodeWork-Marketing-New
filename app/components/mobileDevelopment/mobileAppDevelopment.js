  ...
  const cards = [
    {
      ...
      text: `Custom-built iOS (Swift) and Android (Kotlin) applications ensure superior performance, security, and platform-specific optimization.`,
    },
    {
      title: "Cross-Platform App Development",
      text: `Leverage Flutter and React Native to develop high-quality apps that function across multiple devices while reducing costs and time to market.`,
    },
    {
      title: "Enterprise Mobile Applications",
      text: `Feature-rich enterprise solutions integrate with CRM, ERP, and cloud-based systems, streamlining business processes and enhancing internal communication.`,
    },
    {
      title: "AI-Powered Mobile Apps",
      text: `Incorporate machine learning, chatbots, predictive analytics, and NLP to create intelligent applications that deliver data-driven insights and automation.`,
    },
    {
      title: "Mobile UI/UX Design",
      text: `A user-centric design approach ensures intuitive navigation, high engagement, and optimal user retention across all digital platforms.`,
    },
    {
      title: "UI/UX Design",
      text: `User-centered design that creates intuitive, engaging interfaces. Our design
             process focuses on user research, wireframing, prototyping, and usability
             testing to deliver exceptional user experiences.`,
    },
    {
      title: "Progressive Web Apps (PWAs)",
      text: `Responsive, fast-loading PWAs offer an app-like experience directly from the browser, with offline capabilities and push notifications for enhanced accessibility.`,
    },
     {
      title: "App Maintenance & Optimization",
      text: `Keeping mobile apps updated, secure, and running smoothly. Make sure they stay reliable and work well over time.`,
    },
  ];
