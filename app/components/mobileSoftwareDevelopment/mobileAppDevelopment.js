        ...
        >
          <div className="pt-12 text-white py-8 px-32 w-full flex flex-col text-left">
            <div className="relative z-10 w-full">
              ...
              {/* Section 3 */}
              <div>
                <h3 className="text-lg font-semibold pt-6 pb-1">
                  Deployment and Optimization
                </h3>
                <div className="relative w-[450px] h-[1px] bg-white overflow-hidden">
                  <div className="absolute inset-0 h-full bg-gradient-to-r from-[#1dcaf5] via-white to-[#f04f57] 
...
<ShineBorder
          className="pt-12 mt-32 bg-black text-white py-8 px-32 w-[1200px] h-[556px] 
          rounded-tr-[530px] rounded-br-[530px] relative overflow-hidden ml-[-320px] mb-12" // Added mb-12 for space below
          color={["#1dcaf5", "#f04f57"]}
          borderRadius="0 530px 530px 0"
        >
          <div className="relative z-10">
            ...
            {/* Section 3 */}
            <div>
              <h3 className="text-lg pt-6 font-semibold pb-1">
                Business Impact and Insights
              </h3>
              <div className="relative w-[450px] h-[1px] bg-white overflow-hidden">
                <div className="absolute inset-0 h-full bg-gradient-to-r from-[#1dcaf5] via-white to-[#f04f57] 
        ...
        {/* Title Section */}
        <h2 className="text-white text-2xl font-semibold mb-20 pt-10 -ml-48 flex items-center justify-start">
          <span className="inline-block w-2 h-10 bg-gradient-to-b to-blue-500 from-pink-500 mr-4 rounded-tr-md rounded-br-md"></span>
