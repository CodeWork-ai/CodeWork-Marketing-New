...
import MobileAppCycle from "./mobileAppCycle";
...
let notifications = [
  {
    ...
    description: "Defining business goals and technical architecture.",
    time: "15m ago",
  ...
  {
    name: "UI/UX Design",
    description: "Creating visually appealing, user-friendly interfaces.",
    time: "10m ago",
    icon: <VscNote className="w-8 h-8 text-blue-500" />,
    color: "#3B82F6", // Blue-500 approximate
  },
  {
    name: "Agile Developmen",
    description: "Building secure, scalable, and high-performance apps.",
    time: "8m ago",
  ...
  },
  {
    ...
    description: " Ensuring flawless functionality across devices.",
    time: "6m ago",
    icon: <TbAdjustmentsCode className="w-8 h-8 text-purple-500" />,
    color: "#8B5CF6", // Purple-500 approximate
  },
  {
    name: "Deployment & Launchg",
    description: "Publishing applications on Google Play and the App Store.",
    time: "4m ago",
    icon: <FaAward className="w-8 h-8 text-green-500" />,
    color: "#10B981", // Green-500 approximate
  },
  {
    name: "Ongoing Support & Enhancements",
    description: " Continuous monitoring and feature upgrades.",
