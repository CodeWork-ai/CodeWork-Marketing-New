  ...
  return (
    <div className="bg-gradient-to-b from-[#FBF8E6] to-[#EBF9FF] py-12 pt-40">
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">How Do Neural Networks Work?</h2>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">1. Input Layer</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">2. Hidden Layers</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-2">3. Output Layer</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Types of Neural Networks</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Neural Networks vs. Deep Learning</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">History of Neural Networks</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
