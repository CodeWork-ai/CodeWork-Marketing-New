  ...
  return (
    <div className="bg-primary py-12 pt-40 min-h-screen">
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        {/* TITLE - Main heading 5xl and secondary color */}
        ...
        <p className="text-white/80 leading-relaxed mb-6">
          <strong>Explore More:</strong> Discover the broader impact of AI in our  blog: <em><Link href="/code-generation-automation" className="text-secondary hover:text-secondary/80 underline font-medium">How is AI Transforming Software Development?</Link></em>
        </p>
