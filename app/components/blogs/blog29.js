      ...
      <div className="max-w-screen-xl mx-auto px-4 flex gap-8">
        ...
        <div className="flex-1 max-w-4xl">
          ...
          <section id="phases-of-the-software-lifecycle" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">What are the Phases of the Software Lifecycle?</h2>
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="bg-primary/40 border border-secondary/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-secondary mb-3">Planning</h3>
                <p className="text-white/80 leading-relaxed">
              ...
              <div className="bg-primary/40 border border-secondary/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-secondary mb-3">Design</h3>
                <p className="text-white/80 leading-relaxed">
              ...
              <div className="bg-primary/40 border border-secondary/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-secondary mb-3">Development</h3>
                <p className="text-white/80 leading-relaxed">
              ...
              <div className="bg-primary/40 border border-secondary/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-secondary mb-3">Testing</h3>
                <p className="text-white/80 leading-relaxed">
              ...
              <div className="bg-primary/40 border border-secondary/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-secondary mb-3">Deployment</h3>
                <p className="text-white/80 leading-relaxed">
          ...
          <section id="common-software-lifecycle-models" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">Common Software Lifecycle Models</h2>
            <p className="text-white/80 leading-relaxed mb-4">
              Different teams adopt different SDLC models based on their project goals, timelines, and team size.
            </p>
            <ul className="list-disc ml-6 text-white/80 mb-10 space-y-3">
          ...
          <section id="devops-and-the-software-lifecycle" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">DevOps and the Software Development Lifecycle Model</h2>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <section id="benefits-of-sdlc" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">Benefits of the SDLC</h2>
            <p className="text-white/80 leading-relaxed mb-4">
