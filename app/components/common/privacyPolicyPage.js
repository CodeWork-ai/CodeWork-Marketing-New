  ...
  <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pt-32 pb-16 px-6 flex justify-center">
    <div className="w-full max-w-3xl">
      ...
      <div className="prose lg:prose-lg prose-blue max-w-none">
        {/* Introduction */}
        <section id="introduction" className="p-6 rounded-lg mb-8 text-gray-800 bg-gray-50">
        ...
        <section
          ...
          className="p-6 rounded-lg mb-8 text-gray-800 bg-white"
        >
          <h2 className="flex items-center text-2xl  text-gray-800 font-semibold mb-4">
        ...
        {/* Log Data */}
        <section id="log-data" className="p-6 rounded-lg mb-8 text-gray-800 bg-gray-50">
          <h2 className="flex items-center text-2xl text-gray-800 font-semibold mb-4">
          ...
          <p>
            ...
            newsletters, informational content, or updates related to Codework’s
            services and offerings.
          </p>
        </section>

        {/* Cookies */}
        <section id="cookies" className="p-6 text-gray-800 rounded-lg mb-8 bg-white">
          <h2 className="flex items-center text-2xl font-semibold mb-4">
            <FaCookieBite className="mr-2 text-teal-500 animate-pulse" />
            Cookies
          </h2>
          <p>
            ...
            improve user experience. Cookies may be "session" (deleted after
            use) or "persistent" (stored for future visits). Persistent cookies
        ...
        {/* Data Sharing */}
        <section id="data-sharing" className="p-6 text-gray-800 rounded-lg mb-8 bg-white">
          <h2 className="flex items-center text-2xl font-semibold mb-4">
          ...
          <ul className="list-disc ml-6 mt-2">
            <li>
              Marketing Platforms: CRM tools, email automation platforms,
              advertising networks.
            </li>
            <li>
              Analytics Services: Web analysis tools like Google Analytics.
            </li>
          </ul>
          <p className="mt-4">
        ...
        {/* Security */}
        <section id="security" className="p-6 text-gray-800 rounded-lg mb-8 bg-white">
          <h2 className="flex items-center text-2xl font-semibold mb-4">
        ...
        {/* CCPA Rights */}
        <section id="ccpa-rights" className="p-6 text-gray-800 rounded-lg mb-8 bg-gray-50">
          <h2 className="flex items-center text-2xl font-semibold mb-4">
        ...
        {/* Global Rights */}
        <section id="global-rights" className="p-6 text-gray-800 rounded-lg mb-8 bg-white">
          <h2 className="flex items-center text-2xl font-semibold mb-4">
          ...
          <p>
            ...
            Officer at itsupport@codework.ai. We may require identity
        ...
        {/* Changes */}
        <section id="changes" className="p-6 text-gray-800 rounded-lg mb-8 bg-gray-50">
        ...
        {/* Contact */}
        <section id="contact" className="p-6 text-gray-800 rounded-lg mb-8 bg-white">
