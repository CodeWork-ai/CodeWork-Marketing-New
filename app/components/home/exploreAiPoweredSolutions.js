...
const ExploreAiPoweredSolutions = () => {
    ...
    return (
        <div className="w-full h-full md:flex px-4 sm:px-4 md:px-10 lg:px-14 xl:px-20 pt-10 md:pt-10">
                ...
                <div className="relative w-full h-full md:h-[700px]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="space-y-5 lg:space-y-10 py-5">
                            ...
                            <h3 className="leading-5 md:leading-7 lg:leading-9 text-base lg:text-base 2xl:text-lg text-gray-200 text-center px-3 md:px-10">
                            ...
                            <div className="flex w-full md:w-auto items-center justify-center px-4">
                                <Link href="/driving-innovation-cutting-edge-ai-services" className="w-full md:w-auto">
                                    <button className="bg-[#FF035B] w-full md:w-auto hover:bg-opacity-80 text-black hover:text-white font-medium rounded-sm px-2 py-2 md:px-3 md:py-2 xl:px-5 xl:py-3 text:sm lg:text-base 2xl:text-lg">
            ...
            {/* Right Section */}
            <div className="md:w-6/12 flex items-center justify-center border text-xl md:text-lg text-gray-200 border-gray-700 bg-black bg-opacity-40">
                <ServiceGrid/>
            </div>
        </div>
    );
