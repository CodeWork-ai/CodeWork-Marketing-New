    ...
    <div className="bg-gradient-to-b from-[#FBF8E6] to-[#EBF9FF] py-12 pt-40">
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-10 space-x-3">
          ...
          <span className="uppercase">Neaven Christopher</span>
          <span>•</span>
        ...
        {/* The Seduction of AI */}
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">The Seduction of AI</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Begin with the Basics: Solve the Right Problem First</h2>
        <p className="text-gray-700 leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Build a Foundation First</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Don’t Overcomplicate What Can Be Simplified</h2>
        <p className="text-gray-700 leading-relaxed mb-6">
        ...
        {/* The Way Forward */}
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">The Way Forward: Responsible AI Adoption</h2>
        <p className="text-gray-700 leading-relaxed mb-6">
