        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— Software Development —</span>
            </div>

            {/* Enhanced Heading */}
            <div className="heading-container mb-8 md:mb-10">
              <h1 className="text-5xl font-bold text-white leading-tight mb-6">
                Innovative Software Development for{" "}
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  Building scalable, high-performance software solutions is essential for businesses aiming for <span className="text-secondary font-medium">digital transformation</span>. <span className="">minimum viable product (MVP)</span> to enterprises requiring robust and scalable systems. With expertise in cutting-edge technologies, Codework.ai transforms ideas into high-quality, <span className="text-secondary font-medium">user-centric applications</span>.
                </p>
              </div>
            </div>
          </div>
