          ...
          <div className="lg:col-span-2 text-left">
            ...
            <div className="heading-container mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-white leading-tight mb-6">
                Advanced <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Cybersecurity Solutions</span> for a Secure Digital Future
              </h1>
