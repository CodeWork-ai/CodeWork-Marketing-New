  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6">
      <div className="max-w-4xl w-full">
        ...
        {/* Title Section */}
        <h2 className="text-white text-lg sm:text-2xl font-semibold pt-16 sm:pt-32 -ml-8 sm:-ml-48 
        ...
        <ShineBorder
          className="w-full sm:w-[1200px] h-auto sm:h-[456px] bg-black relative ml-0 sm:ml-2 overflow-hidden 
            flex flex-col mt-16 sm:mt-32 rounded-tl-[200px] sm:rounded-tl-[530px] 
            rounded-bl-[200px] sm:rounded-bl-[530px]"
          color={["#1dcaf5", "#f04f57"]}
        ...
        <ShineBorder
          className="pt-8 sm:pt-12 mt-16 sm:mt-32 bg-black text-white py-6 sm:py-8 px-8 sm:px-16 md:px-32 
            w-full sm:w-[1200px] h-auto sm:h-[456px] rounded-tr-[200px] sm:rounded-tr-[530px] 
            rounded-br-[200px] sm:rounded-br-[530px] relative overflow-hidden ml-0 sm:ml-[-320px]"
          color={["#1dcaf5", "#f04f57"]}
          borderRadius="0 530px 530px 0"
        >
        ...
        <h2 className="text-white text-lg sm:text-2xl font-semibold mb-16 sm:mb-20 pt-12 sm:pt-16 
          -ml-8 sm:-ml-48 flex items-center justify-start">
          <span className="inline-block w-2 h-8 sm:h-10 bg-gradient-to-b to-blue-500 from-pink-500 
            mr-3 sm:mr-4 rounded-tr-md rounded-br-md"></span>
