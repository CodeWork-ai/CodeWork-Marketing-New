          ...
          <div className="lg:col-span-2 text-left">
            ...
            <div className="heading-container mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-white leading-tight mb-6">
                <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Penetration Testing</span> Services: Strengthening Cybersecurity with Ethical Hacking
              </h1>
            ...
            <div className="paragraph-container mb-8 max-w-3xl">
              <p className="text-lg text-white/90 leading-relaxed pl-4 border-l-4 border-secondary/40">
                <span className="text-secondary font-medium">Cyber threats</span> continue to evolve, making it crucial to identify and eliminate <span className="text-secondary font-medium">security vulnerabilities</span> before malicious hackers exploit them. <span className="text-secondary font-medium">Codework.ai</span> provides comprehensive <span className="text-secondary font-medium">penetration testing services</span>, simulating real-world cyberattacks to detect security flaws across networks, applications, and cloud environments.
              </p>
              
              <div className="mt-6">
                <h3 className="text-lg font-semibold text-secondary mb-4">By proactively addressing security risks, businesses can maintain a robust cybersecurity posture and safeguard sensitive data.</h3>
              </div>
            </div>
          </div>
