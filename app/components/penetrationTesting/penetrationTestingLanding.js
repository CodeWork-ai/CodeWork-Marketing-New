...
const PenetrationTestingLanding = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— Penetration Testing Services —</span>
            </div>
            ...
            <div className="heading-container mb-8 md:mb-10">
              <h1 className="text-5xl font-bold text-white leading-tight mb-6">
                ...
                Services: Strengthening Cybersecurity with Ethical Hacking
              </h1>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  <span className="text-secondary font-medium">Cyber threats</span> continue to evolve, making it crucial to identify and eliminate <span className="text-secondary font-medium">security vulnerabilities</span> before malicious hackers exploit them. <span className="text-secondary font-medium">Codework.ai</span> provides comprehensive <span className="text-secondary font-medium">penetration testing services</span>, simulating real-world cyberattacks to detect security flaws across networks, applications, and cloud environments. By proactively addressing security risks, businesses can maintain a robust <span className="text-secondary font-medium">cybersecurity posture</span> and safeguard sensitive data.
                </p>
              </div>
            </div>
          </div>

          {/* Right Side - Enhanced Services (4 columns) - NO HEADER ICON */}
...
export default PenetrationTestingLanding;
