...
export default function PenetrationTesting() {
  ...
  const cards = [
    {
      ...
      text: `Internal and external networks, firewalls, and servers undergo rigorous security assessments to detect unauthorized access risks.`,
    },
    {
      title: "Web Application Penetration Testing",
      text: `Web applications are tested for vulnerabilities such as SQL injection, cross-site scripting (XSS), and authentication flaws, ensuring robust security.`,
    },
    {
      title: "Cloud Security Testing",
      text: `Security evaluations for AWS, Azure, Google Cloud, and hybrid environments help identify misconfigurations and potential threats.`,
    },
    {
      title: "API & Mobile App Security Testing",
      text: `Mobile applications and APIs are analyzed to detect security weaknesses that may expose sensitive data.`,
    },
    {
      title: "Wireless Network Security Testing",
      text: `Wi-Fi security assessments identify weak encryption, rogue access points, and unauthorized access threats.`,
    },
    {
      title: "Social Engineering & Phishing Simulations",
      text: `Employee awareness is tested through phishing simulations and social engineering attacks, improving security training initiatives.`,
    },
    {
      title: "Red Teaming & Advanced Attack Simulations",
      text: `A full-scale cyberattack simulation assesses physical security, human vulnerabilities, and digital defense mechanisms.`,
    },
  ];
  ...
  // Ensure slideCount is valid
  const slideCount = cardsPerView > 0 ? Math.ceil(cards.length / cardsPerView) : 1;
