    ...
    <div>
      ...
      <div className="flex flex-col bg-gradient-to-b from-[#f0fbff] to-[#e7f8ff] lg:flex-row px-7 gap-10 pt-36  pb-10">
        ...
        <div className="flex-1 bg-white p-6 sm:p-8 rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.05)]">
          <h2 className="text-[#30d6df] font-semibold text-2xl mb-6">
            REQUEST A DEMO
          </h2>
          ...
          <form onSubmit={handleSubmit} className="flex  text-black flex-col space-y-4">
              ...
              {["first_name", "last_name"].map((field) => (
                <div className="flex-1" key={field}>
                  ...
                  <input
                    ...
                    className="w-full p-3 text-sm border border-[#30d6df] rounded-lg placeholder-[#30d6df] outline-none"
                    placeholder={`Enter ${
            ...
            <div className="flex items-start space-x-2 text-xs text-[#5C5C5C]">
              ...
              <label>
                ...
                <a href="https://codework.ai/privacy-policy" className="text-[#30d6df] underline">
                  Privacy Policy
                </a>
                .
              </label>
            ...
            <button
              ...
              className={`w-full mt-4 py-3.5 text-base font-medium rounded-lg transition ${
                loading
                  ...
                  : "bg-[#30d6df] text-white hover:opacity-90"
              }`}
            >
            ...
            {/* Response Message */}
            {responseMessage && (
              <p className="mt-4 text-center text-sm text-[#30d6df]">
                {responseMessage}
              </p>
            )}
          </form>
        ...
        <div className="flex-1">
          ...
          {accordionData.map((item, idx) => (
            <div
              key={idx}
              className="border border-[#30d6df] rounded-lg mb-3 overflow-hidden"
            >
              <div
                onClick={() => toggle(idx)}
                className={`flex justify-between items-center px-4 py-3 cursor-pointer text-base font-medium ${
                  activeIndex === idx
                    ? "bg-[#30d6df] text-white"
                    : "bg-white text-[#30d6df]"
                }`}
              >
