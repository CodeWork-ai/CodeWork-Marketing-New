...
const GroupsFeed = () => {
  return (
    <div className="bg-black bg-opacity-70 text-white px-4 sm:px-4 md:px-10 lg:px-14 xl:px-20 py-32 font-sans">
      ...
      <p className="text-gray-400">View groups and posts below.</p>

      {/* Post Container */}
      <div className="bg-black bg-opacity-0 border border-gray-800 rounded-lg p-5 mt-5">
        <p className="text-xs text-gray-500">This post is from a suggested group</p>
        ...
        <div className="flex items-start mt-4">
          ...
          <div className="ml-4">
            ...
            <p className="text-xs text-gray-500">6 days ago • posted in CodeWork Group</p>
            ...
            <div className="flex items-center mt-4 space-x-4 text-gray-400 text-sm">
        ...
        <textarea
          className="w-full bg-black bg-opacity-40 border border-gray-600 text-sm text-gray-300 h-36 mt-4 p-2 rounded-md"
