...
const AiCommunityLanding = () => {
  return (
    <section className="relative w-full h-auto sm:h-[80vh] md:h-screen flex items-center bg-[#F6F5FF]">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden bg-cover bg-center bg-[url('/landingpages/AICommunityLandin.jpeg')]"></div>
      ...
      <div className="relative z-10 w-[80%] mx-auto px-4 text-left text-gray-800">
        ...
        <div className="paragraph-container mb-8">
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl leading-relaxed text-gray-800">
            A space where innovators, learners, and AI enthusiasts come together to explore the endless possibilities of artificial intelligence.
          </p>
        </div>
      </div>
    </section>
...
export default AiCommunityLanding;
