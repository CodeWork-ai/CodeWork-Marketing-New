...
const InternshipProgram = () => {
    return (
        <div className="px-4 sm:px-4 md:px-10 lg:px-14 text-gray-800 xl:px-20 py-16 bg-gradient-to-b from-[#FBF8E6] to-[#ebf9ff]">
            <div className="text-center">
                <h1 className="text-3xl font-bold  mb-4">CODEWORK Internship Program</h1>
                <p className="text-xl ">
            ...
            <section className="mt-12">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold t">Skill Development</h3>
                            <p className="">
            ...
            <section className="mt-12">
                <h2 className="text-3xl font-semibold  mb-6">Program Outcomes</h2>
