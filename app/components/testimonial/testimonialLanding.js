...
const TestimonialLanding = () => {
  return (
    <section className="relative w-full h-auto sm:h-[80vh] md:h-screen flex items-center bg-[#F6F5FF]">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden bg-cover bg-center bg-[url('/landingpages/TestimonialLandin.jpeg')]"></div>
...
Hear from our clients! Discover how our services have made a lasting impact. Their words inspire us to keep delivering exceptional results.</p>
        </div>
      </div>
    </section>
  );
