...
const IndustriesCards = () => {
  const cardData = [
    ...
    },
    {
      ...
      description: 'AI in data security refers to the use of artificial intelligence to detect, prevent, and respond to cybersecurity threats by analyzing patterns.',
    ...
    <div className="bg-primary relative overflow-hidden px-4 py-20">
      ...
      <div className="text-center mb-16 relative z-10">
        <div className="inline-flex items-center px-6 py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-8">
          <span className="text-secondary text-sm font-medium">— AI Solutions by Industry —</span>
        </div>
        ...
        <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
          Discover how our AI solutions are revolutionizing different sectors with cutting-edge technology and innovative approaches.
        </p>
      </div>
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                  <Link
                    href={card.link}
                    className="inline-flex items-center bg-gradient-to-r from-secondary to-secondary/80 text-primary font-bold px-6 py-3 rounded-xl hover:from-secondary/90 hover:to-secondary hover:shadow-lg hover:shadow-secondary/25 transform hover:scale-105 transition-all duration-300 relative overflow-hidden group/btn"
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-12 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000 ease-out"></div>
                  </Link>
                </div>
              </div>
