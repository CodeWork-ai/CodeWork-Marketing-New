      ...
      <section className="bg-gradient-to-b w-full py-12 sm:py-16 md:py-24 lg:py-36 pt-20 sm:pt-16 md:pt-24 lg:pt-36 relative"> {/* Added relative for logo positioning */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <img
            src="/Hyperflx.svg"
            alt="Hyperflx Logo"
            className="absolute top-28 left-4 w-48 h-auto z-30" /* Adjust size (e.g., w-24) and positioning as needed */
          />
          <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 lg:pr-8"> {/* Changed to justify-center for balanced positioning; added lg:pr-8 for slight right padding */}
            ...
            <div className="w-full lg:w-4/12 xl:w-5/12 bg-gradient-to-br from-[#FBF8E6] to-[#f5fdff] p-4 sm:p-6 lg:p-6 xl:p-8 rounded-xl sm:rounded-2xl text-gray-800 z-20 
                         ...
                         shadow-md lg:shadow-lg lg:ml-4"> {/* Reduced to lg:ml-4 for more leftward positioning */}
            ...
            <div className="w-full lg:w-5/12 xl:w-1/2 
                         ...
                         order-1 lg:order-2 lg:ml-2"> {/* Reduced to lg:ml-2 for more leftward positioning */}
              <img
