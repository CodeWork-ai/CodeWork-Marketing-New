...
export default function DevopsDevelopment() {
  ...
  const cards = [
    ...
    },
    {
      ...
      text: `Scalable cloud solutions that optimize infrastructure costs and improve accessibility.
             Our cloud services include migration, architecture design, and ongoing management
             to ensure your applications run efficiently and securely.`,
    },
    {
  ...
  const slideCount =
    cards.length > 0 ? Math.ceil(cards.length / cardsPerView) : 1; // Fixed calculation
