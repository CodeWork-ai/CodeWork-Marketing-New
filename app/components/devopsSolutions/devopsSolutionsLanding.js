        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— DevOps Solutions —</span>
            </div>
            ...
            <div className="heading-container mb-8 md:mb-10">
              <h1 className="text-5xl font-bold text-white leading-tight mb-6">
                ...
                Solutions for Accelerated Software Delivery
              </h1>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  In today's <span className="text-secondary font-medium">digital era</span>, businesses must develop, test, and deploy software efficiently. <span className="text-secondary font-medium">Codework.ai</span> offers advanced <span className="text-secondary font-medium">DevOps solutions</span> to streamline workflows, enhance collaboration, and optimize deployment. By integrating development and operations, businesses achieve faster software delivery with security, scalability, and efficiency.
                </p>
              </div>
            </div>
          </div>
