...
const SoftwareProcessCycle = () => {
  ...
  const icons = [
    ...
    { icon: <HiCubeTransparent size={40} />, borderColor: "border-orange-500", textColor: "text-orange-500" },
  ];
...
let notifications = [
  {
    ...
    description: "Understanding specific staffing requirements and project objectives.",
    time: "15m ago",
    icon: <LuNotepadText className="w-8 h-8 text-yellow-500" />,
    color: "#FFFF00", // Yellow-500 approximate
  },
  {
    name: "Talent Sourcing",
    description: "Pre-vetted professionals matched to business needs.",
    time: "10m ago",
    icon: <MdPersonSearch className="w-8 h-8 text-blue-500" />,
    color: "#3B82F6", // Blue-500 approximate
  },
  {
    name: "Performance Monitoring",
    description: "Continuous support and performance optimization.",
    time: "8m ago",
    icon: <HiCubeTransparent className="w-8 h-8 text-red-500" />,
    color: "#EF4444", // Red-500 approximate
  },
  {
    name: "Flexible Scaling",
    description: "Expansion or reduction of workforce as project demands evolve.",
    time: "6m ago",
  ...
  },
  {
    ...
    time: "4m ago",
    icon: <TbLocationSearch className="w-8 h-8 text-green-500" />,
