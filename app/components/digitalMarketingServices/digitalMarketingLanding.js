        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full border border-secondary/30 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
              <span className="text-secondary text-sm font-medium">— Digital Marketing Solutions —</span>
            </div>
            ...
            <div className="paragraph-container mb-8 md:mb-10 max-w-4xl mx-auto lg:mx-0">
              <div className="relative">
                ...
                <p className="text-lg text-white/90 leading-relaxed lg:pl-8 font-light">
                  <span className="text-secondary font-medium">Digital Marketing strategies</span> for businesses to improve their <span className="text-secondary font-medium">online reach</span>, attract potential leads, and boost <span className="text-secondary font-medium">conversions</span>. Our comprehensive approach ensures maximum ROI and sustainable growth in the digital landscape.
                </p>
              </div>
            </div>
          </div>
