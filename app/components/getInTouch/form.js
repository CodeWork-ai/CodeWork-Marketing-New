...
const ContactForm = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-between bg-black bg-opacity-40 text-white p-8 md:p-16 space-y-8 md:space-y-2">
            {/* Left Section */}
            ...
            <ShineBorder className="relative flex flex-col bg-black bg-opacity-50 overflow-hidden rounded-lg md:shadow-xl"
                ...
                <form
                    ...
                    className="flex-1 bg-black bg-opacity-5 p-6 rounded-md shadow-md space-y-6"
                >
                    {/* First and Last Name */}
                    <input
                        type="text"
