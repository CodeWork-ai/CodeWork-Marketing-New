...
let notifications = [
  {
    name: "Reconnaissance & Threat Mapping",
    description: "Potential entry points and exploitable vulnerabilities are identified through cyber risk assessments.",
    time: "15m ago",
    icon: <AiOutlineFileSearch className="w-8 h-8 text-yellow-500" />,
    color: "#FFFF00", // Yellow-500 approximate
  },
  {
    name: "Exploitation & Attack Simulation",
    description: "Real-world cyberattacks are simulated to test the effectiveness of security defenses.",
    time: "10m ago",
    icon: <MdOutlineSecurity className="w-8 h-8 text-blue-500" />,
    color: "#3B82F6", // Blue-500 approximate
  },
  {
    name: "Post-Exploitation Analysis",
    description: "The impact of security breaches on sensitive data and business operations is evaluated.",
    time: "8m ago",
    icon: <BsTools className="w-8 h-8 text-red-500" />,
    color: "#EF4444", // Red-500 approximate
  },
  {
    name: "Comprehensive Security Reporting & Risk Mitigation",
    description: "Detailed security reports provide actionable recommendations for addressing vulnerabilities.",
    time: "6m ago",
    icon: <TbMapSearch className="w-8 h-8 text-purple-500" />,
    color: "#8B5CF6", // Purple-500 approximate
  },
  {
    name: "Remediation Support & Retesting",
    description: "Guidance on fixing vulnerabilities is provided, followed by retesting to validate security enhancements.",
    time: "4m ago",
    icon: <MdOutlineNoteAdd className="w-8 h-8 text-green-500" />,
...
export default PenetrationTestingMethodology;