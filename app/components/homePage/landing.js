...
const Landing = () => {
  ...
  <Link href="/contact-ai-solutions">
    <button
      className="inline-flex items-center space-x-2 px-5 py-3 sm:px-6 md:px-7 lg:px-8 xl:px-10 sm:py-3 md:py-3 lg:py-4 xl:py-4 rounded-full font-semibold text-sm md:text-base"
      style={{
