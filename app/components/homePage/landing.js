...
const Landing = () => {
  return (
    <section className="relative w-full h-auto sm:h-[80vh] md:h-screen flex items-center bg-primary overflow-hidden">
      {/* Gradient Background with Stars Effect */}
      <div className="absolute inset-0 w-full h-full">
        {/* Main gradient background */}
        <div
          className="absolute inset-0 w-full h-full"
          style={{
            background: `linear-gradient(135deg, #050c25 0%, #050c25 30%, #050c25 70%, #050c25 100%)`,
          }}
        ></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 lg:w-3/5 text-center md:text-left pt-12 md:pt-0">
            ...
            {/* Enhanced Paragraph Container - Extended to 70% of screen width */}
            <div className="paragraph-container mb-10 sm:mb-12 w-full lg:w-[70vw] xl:w-[70vw]">
              <p className="text-base sm:text-lg md:text-xl lg:text-xl leading-relaxed text-white/90 font-light">
                We craft intelligent software solutions <span className="text-secondary font-medium">intelligent software solutions  </span> powered by AI, driving
                innovation across industries. From automation to smart applications,
                we transform <span className=" font-medium">ideas into future-ready</span> digital experiences.
              </p>
            ...
            {/* Additional Stats or Features - Left Aligned */}
