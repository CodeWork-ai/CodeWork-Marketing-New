      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="md:w-1/2 ml-0 md:-ml-6 lg:ml-6 mb-8 md:mb-0 md:pr-8">
          ...
          <div className="flex flex-row flex-wrap gap-4">
            {/* Card 1 */}
            <div className="group relative bg-white border-[2px] border-[#75def9] border-t-0 border-l-0 rounded-tl-2xl rounded-tr-[100px] rounded-bl-2xl rounded-br-2xl p-4 sm:p-6 shadow-md w-full max-w-md md:max-w-lg min-h-[100px] transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-gradient-to-r hover:from-[#7C9AEF] hover:to-[#79D0FD]">
            ...
            <div className="group relative bg-white border-[2px] border-[#75def9] border-t-0 border-l-0 rounded-tl-2xl rounded-tr-[100px] rounded-bl-2xl rounded-br-2xl p-4 sm:p-6 shadow-md w-full max-w-md md:max-w-lg min-h-[100px] transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-gradient-to-r hover:from-[#7C9AEF] hover:to-[#79D0FD]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black w-3/4 mb-1">
