...
const SolutionsEcosystem = () => {
    ...
    return (
        <div className="w-full md:flex px-4 sm:px-4 md:px-10 lg:px-14 xl:px-20 bg-black bg-opacity-30">
            ...
            {/* Right Section */}
            <div className="md:w-6/12 flex items-center border h-full md:h-[400px] text-xl md:text-lg text-gray-400 border-gray-700 bg-black bg-opacity-5 px-5 lg:px-20 2xl:px-44">
                <div className="py-5">
                    <h3 className="leading-9 text-base lg:text-base 2xl:text-lg text-gray-400">
                        Our solutions seamlessly integrate with your existing business ecosystem, ensuring a smooth transition and minimal disruption to your operations. We understand the importance of aligning with your systems and processes, providing a tailored approach to integration.
                    </h3>
                    {/* <div className="pt-5">
                        <div className="">
                            <Link href="/solution">
