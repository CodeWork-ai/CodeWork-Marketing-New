            ...
            <div className="lg:col-span-2 text-left">
              ...
              <div className="heading-container mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  Empower Your Business with <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Agentic AI</span>
                </h1>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-white space-y-8">
              {/* Section Badge */}
              <div className="inline-flex items-center border border-secondary/30 bg-white/5 backdrop-blur-sm text-secondary px-6 py-3 rounded-full text-sm font-medium">
                <span className="w-2 h-2 bg-secondary rounded-full mr-2 animate-pulse"></span>
              ...
              <div>
                <h2 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
                  <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Advanced Intelligence</span> That Works Independently
                </h2>
                {/* Decorative underline */}
                <div className="w-20 h-1 bg-gradient-to-r from-secondary to-transparent rounded-full mb-8"></div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-secondary to-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h3 className="text-xl font-semibold text-secondary mb-2">Proactive Intelligence</h3>
                    <p className="text-white/90 leading-relaxed">Our agents forecast requirements, initiate action, and refine efficiency with no human checkpoint.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-secondary to-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h3 className="text-xl font-semibold text-secondary mb-2">Smart Decision-Making</h3>
                    <p className="text-white/90 leading-relaxed">Embedded reasoning and contextual grasp yields simultaneous insight and optimum effect.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-secondary to-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h3 className="text-xl font-semibold text-secondary mb-2">Scalable Solutions</h3>
                    <p className="text-white/90 leading-relaxed">From the garage startup to the continent-spanning conglomerate, our architecture flexes to sector specifics and grows effortlessly.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-secondary to-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h3 className="text-xl font-semibold text-secondary mb-2">Enhanced Productivity</h3>
                    <p className="text-white/90 leading-relaxed">Repetitive, multifaceted routines are yielded to agents, liberating teams for next-generation innovation.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-secondary to-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                    <h3 className="text-xl font-semibold text-secondary mb-2">Human + AI Collaboration</h3>
                    <p className="text-white/90 leading-relaxed">Agents are crafted to augment human capability, multiplying output with diminishing effort.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative group">
                {/* Glow effect */}
                <div className="absolute -inset-4 bg-gradient-to-r from-secondary/30 to-cyan-400/30 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                
                {/* Image container */}
                <div className="relative bg-primary/50 backdrop-blur-sm rounded-3xl border border-white/20 p-8 shadow-2xl">
                  <Image
                    src="/blog/blog14.jpg"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Comprehensive <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">AI Agent Solutions</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-r from-secondary to-cyan-400 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-4">Customer Experience Automation</h3>
              <p className="text-white/80 leading-relaxed">Continuous, intelligent agents deliver personalized support and engagement around the clock.</p>
            </div>
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Business Process Automation</h3>
              <p className="text-white/80 leading-relaxed">Autonomous execution brings order, timing, and component interlock to operations, programs, and workflows.</p>
            </div>
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Healthcare AI Agents</h3>
              <p className="text-white/80 leading-relaxed">Diagnostic support, patient safety monitoring, and evidence-fueled healthcare outcomes converge within autonomous agents.</p>
            </div>
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Financial Intelligence</h3>
              <p className="text-white/80 leading-relaxed">AI uncovers fraud, governs risk through automation, and drives strategic trading with laser-accurate insight.</p>
            </div>
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Marketing and Sales AI</h3>
              <p className="text-white/80 leading-relaxed">Deploy tailored recommendations, tap into predictive insights, and supercharge campaigns through streamlined automation to drive higher conversion rates.</p>
            </div>
            ...
            <div className="group bg-primary/70 backdrop-blur-xl rounded-3xl border border-white/20 p-8 hover:bg-primary/80 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-white mb-4">IT and Security Automation</h3>
              <p className="text-white/80 leading-relaxed">Employ continuous autonomous monitoring, sophisticated threat detection, and self-managing systems to fortify your digital defenses and ensure enduring resilience.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-primary overflow-hidden py-20 px-4 sm:px-6 lg:px-20">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-8">
            Transform Your Business with <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Agentic AI</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="group relative px-8 py-4 bg-gradient-to-r from-secondary to-cyan-400 text-primary font-bold rounded-full overflow-hidden hover:shadow-xl hover:shadow-secondary/25 transition-all duration-300">
            ...
            <button className="group px-8 py-4 border-2 border-secondary text-secondary font-bold rounded-full hover:bg-secondary hover:text-primary transition-all duration-300">
              <span>Learn More About Our Solutions</span>
            </button>
          </div>

          <p className="text-secondary font-semibold mt-8 text-lg">
